  ...
  render: function(){
    ...
    <div id="header-wrapper">
      <div className="page-header">
        <h1> CHAD &nbsp; HASELDEN</h1>
        <a href="#about" onClick={this._routeTo}><h1>ABOUT</h1></a>
        <a href="#myprocess" onClick={this._routeToProcess}><h1>PROCESS</h1></a>
...
ReactDOM.render(<WebSite/>, document.querySelector('#app-container'))

const AppRouter = Backbone.Router.extend({
  routes: {
  "about" : "showAboutMeView",
  "myprocess" : "showProcessView",
  },
  ...
  showProcessView:function(){
      ...
      //  ReactDOM.render(<AppViewController routedFrom="ProcessView"/>, document.querySelector('#app-container') )
    },
